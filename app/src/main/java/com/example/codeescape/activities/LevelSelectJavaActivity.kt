...
class LevelSelectJavaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tvLevelSelectTitle).text = "☕ JAVA — SELECCIONA NIVEL"
    ...
    private fun actualizarNiveles() {
        ...
        val completados = listOf(
            true,
            prefs.getBoolean("ja_nivel1_completo", false),
            prefs.getBoolean("ja_nivel2_completo", false),
            prefs.getBoolean("ja_nivel3_completo", false),
            prefs.getBoolean("ja_nivel4_completo", false),
            prefs.getBoolean("ja_nivel5_completo", false),
            prefs.getBoolean("ja_nivel6_completo", false)
        )
        ...
        val activities = listOf(
            Level1JavaActivity::class.java,
            Level2JavaActivity::class.java,
            Level3JavaActivity::class.java,
            Level4JavaActivity::class.java,
            Level5JavaActivity::class.java,
            Level6JavaActivity::class.java,
            Level7JavaActivity::class.java
        )
