...
class Level2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnPrinter: Button = findViewById(R.id.btnPrinter)
        val btnDoor: Button = findViewById(R.id.btnDoor2)
        val btnBack: Button = findViewById(R.id.btnBackLevel2)
        val btnVolume: Button = findViewById(R.id.btnVolume)

        btnVolume.setOnClickListener { VolumeDialog.show(this) }

        btnArchive.setOnClickListener {
            val intent = Intent(this, SubLevel2Activity::class.java)
        ...
        btnPrinter.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero revisa el archivador", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevel2Activity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Archivador resuelto!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Impresora resuelta!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvProgress2)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnDoor2)
            val tvDoorStatus: TextView = findViewById(R.id.tvDoorStatus2)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("nivel2_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡ESCAPASTE!")
            .setMessage("Has resuelto el Nivel 2.\n\n> Nivel 3 desbloqueado.")
