...
class Level6JavaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnStack.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Revisa la JVM primero", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelJavaActivity::class.java)
        ...
        btnDoor.setOnClickListener {
            when {
                !sublevel1Done || !sublevel2Done -> {
                    Toast.makeText(this, "🔒 Estabiliza el Stack primero", Toast.LENGTH_SHORT).show()
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ JVM estabilizada!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ Stack verificado!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvJaProgress6)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnJaDoor6)
            val tvDoorStatus: TextView = findViewById(R.id.tvJaDoorStatus6)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("ja_nivel6_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡JVM DOMINADA!")
            .setMessage("Has completado el Nivel JVM de Java.\n\n> Nivel MASTER CLASS desbloqueado.")
