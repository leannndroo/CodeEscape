...
class Level3PythonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level3_python)
        ...
        val btnDrone: Button = findViewById(R.id.btnDrone)
        val btnDoor: Button = findViewById(R.id.btnPyDoor3)
        val btnBack: Button = findViewById(R.id.btnBackPy3)
        ...
        btnDrone.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero revisa la caja", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelPythonActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Caja resuelta!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Drone resuelto!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvPyProgress3)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnPyDoor3)
            val tvDoorStatus: TextView = findViewById(R.id.tvPyDoorStatus3)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("py_nivel3_completo", true).apply()
        prefs.edit().putBoolean("python_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🏆 ¡PYTHON COMPLETADO!")
            .setMessage("¡Has completado todos los niveles de Python!\n\n> Ahora intenta Java o Kotlin.")
