...
class Level5KotlinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level5_kotlin)
        ...
        val btnDoor: Button = findViewById(R.id.btnKtDoor5)
        val btnBack: Button = findViewById(R.id.btnBackKt5)
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> {
                    sublevel1Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ Herencia establecida", Toast.LENGTH_SHORT).show()
                }
                2 -> {
                    sublevel2Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ OPEN definido", Toast.LENGTH_SHORT).show()
                }
                3 -> {
                    sublevel3Done = true
                    actualizarProgreso()
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvKtProgress5)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnKtDoor5)
            val tvDoorStatus: TextView = findViewById(R.id.tvKtDoorStatus5)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("kt_nivel5_completo", true).apply()
