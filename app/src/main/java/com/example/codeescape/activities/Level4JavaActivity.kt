...
class Level4JavaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level4_java)
        ...
        val btnFirewall: Button = findViewById(R.id.btnFirewall)
        val btnDoor: Button = findViewById(R.id.btnJaDoor4)
        val btnBack: Button = findViewById(R.id.btnBackJa4)
        ...
        btnFirewall.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero accede a la terminal", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelJavaActivity::class.java)
        ...
        btnDoor.setOnClickListener {
            when {
                !sublevel1Done || !sublevel2Done -> {
                    Toast.makeText(this, "🔒 Desactiva la seguridad primero", Toast.LENGTH_SHORT).show()
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ Terminal hackeada!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ Firewall burlado!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvJaProgress4)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnJaDoor4)
            val tvDoorStatus: TextView = findViewById(R.id.tvJaDoorStatus4)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("ja_nivel4_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡SEGURIDAD SUPERADA!")
            .setMessage("Has completado el Nivel COMPILADOR de Java.\n\n> Nivel BYTECODE desbloqueado.")
