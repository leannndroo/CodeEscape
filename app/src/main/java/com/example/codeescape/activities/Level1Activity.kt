...
class Level1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnTV: Button = findViewById(R.id.btnTV)
        val btnComputer: Button = findViewById(R.id.btnComputer)
        val btnDoor: Button = findViewById(R.id.btnDoor)
        val btnBack: Button = findViewById(R.id.btnBackLevel)
        ...
        btnTV.setOnClickListener {
            val intent = Intent(this, SubLevelActivity::class.java)
        ...
        btnComputer.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero revisa el televisor", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Televisor resuelto!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Computador resuelto!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnDoor)
            val tvDoorStatus: TextView = findViewById(R.id.tvDoorStatus)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("nivel1_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡ESCAPASTE!")
            .setMessage("Has resuelto todos los acertijos.\n\n> Nivel 2 desbloqueado.")
