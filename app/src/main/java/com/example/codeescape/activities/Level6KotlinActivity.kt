...
class Level6KotlinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level6_kotlin)
        ...
        val btnDoor: Button = findViewById(R.id.btnKtDoor6)
        val btnBack: Button = findViewById(R.id.btnBackKt6)
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> {
                    sublevel1Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ Interface creada", Toast.LENGTH_SHORT).show()
                }
                2 -> {
                    sublevel2Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ Lambda funcional", Toast.LENGTH_SHORT).show()
                }
                3 -> {
                    sublevel3Done = true
                    actualizarProgreso()
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvKtProgress6)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnKtDoor6)
            val tvDoorStatus: TextView = findViewById(R.id.tvKtDoorStatus6)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("kt_nivel6_completo", true).apply()
