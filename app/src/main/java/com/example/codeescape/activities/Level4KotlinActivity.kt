...
class Level4KotlinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level4_kotlin)
        ...
        val btnDoor: Button = findViewById(R.id.btnKtDoor4)
        val btnBack: Button = findViewById(R.id.btnBackKt4)
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> {
                    sublevel1Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ INIT configurado", Toast.LENGTH_SHORT).show()
                }
                2 -> {
                    sublevel2Done = true
                    actualizarProgreso()
                    Toast.makeText(this, "✅ SELF reconocido", Toast.LENGTH_SHORT).show()
                }
                3 -> {
                    sublevel3Done = true
                    actualizarProgreso()
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvKtProgress4)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnKtDoor4)
            val tvDoorStatus: TextView = findViewById(R.id.tvKtDoorStatus4)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("kt_nivel4_completo", true).apply()
