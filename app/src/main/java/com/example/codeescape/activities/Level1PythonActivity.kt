...
class Level1PythonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level1_python)
        ...
        val btnLaptop: Button = findViewById(R.id.btnLaptop)
        val btnDoor: Button = findViewById(R.id.btnPyDoor1)
        val btnBack: Button = findViewById(R.id.btnBackPy1)
        ...
        btnLaptop.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero revisa el libro", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelPythonActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Libro resuelto!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Laptop resuelta!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvPyProgress1)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnPyDoor1)
            val tvDoorStatus: TextView = findViewById(R.id.tvPyDoorStatus1)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("py_nivel1_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡ESCAPASTE!")
            .setMessage("Has resuelto el Nivel 1 de Python.\n\n> Nivel 2 desbloqueado.")
