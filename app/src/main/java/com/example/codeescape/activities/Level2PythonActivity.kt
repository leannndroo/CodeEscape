...
class Level2PythonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level2_python)

        playerPuerta = MediaPlayer.create(this, R.raw.sonido_puerta)
        GameManager.reiniciarVidas()

        val btnBoard: Button = findViewById(R.id.btnBoard)
        val btnTerminal: Button = findViewById(R.id.btnTerminal)
        val btnDoor: Button = findViewById(R.id.btnPyDoor2)
        val btnBack: Button = findViewById(R.id.btnBackPy2)
        ...
        btnTerminal.setOnClickListener {
            if (!sublevel1Done) {
                Toast.makeText(this, "⚠️ Primero revisa la pizarra", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this, SubLevelPythonActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                1 -> { sublevel1Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Pizarra resuelta!", Toast.LENGTH_SHORT).show() }
                2 -> { sublevel2Done = true; actualizarProgreso(); Toast.makeText(this, "✅ ¡Terminal resuelto!", Toast.LENGTH_SHORT).show() }
    ...
    private fun actualizarProgreso() {
        val tvProgress: TextView = findViewById(R.id.tvPyProgress2)
        ...
        if (sublevel1Done && sublevel2Done) {
            val btnDoor: Button = findViewById(R.id.btnPyDoor2)
            val tvDoorStatus: TextView = findViewById(R.id.tvPyDoorStatus2)
    ...
    private fun mostrarVictoria() {
        ...
        prefs.edit().putBoolean("py_nivel2_completo", true).apply()
        GameManager.nivelCompletado()
        GameManager.guardar(this)

        AlertDialog.Builder(this)
            .setTitle("🎉 ¡ESCAPASTE!")
            .setMessage("Has resuelto el Nivel 2 de Python.\n\n> Nivel 3 desbloqueado.")
